...
<input type="checkbox" name="p2" value="2" />Plastering on wall.
</tr>
...
<td></td><td align="left">
<input type="checkbox" name="p3" value="4" />Fencing problem.
</td>
</tr>
...
<td>&nbsp;</td><td align="left">
<input type="checkbox" name="p4" value="8" />Room leakage.</td>
</tr>
<tr>
<td>&nbsp;</td>
...
<br /><input type="checkbox" name="o1" value="1"  />Rooms<br />
<input type="checkbox" name="o2" value="2"  />Toilets<br/>
<input type="checkbox" name="o3" value="4"  />Corridor<br/>
</div>

</td><td align="left">
<input type="checkbox" name="p5" value="16" />Roof leakage.</td>
</tr>
<tr>
...
<td align="left">
<input type="checkbox" name="p6" value="32" />Flooring.<br />
...
<div id="left">
	<div class="box">
			<marquee>National Institute of Technology</marquee>
	</div>
